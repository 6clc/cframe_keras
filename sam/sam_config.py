...
imgs_train_path = '/home/he/Data/DataSets/SALICON/images/train/'
# path of training maps
maps_train_path = '/home/he/Data/DataSets/SALICON/maps/train/'
# path of training fixation maps
fixs_train_path = '/home/he/Data/DataSets/SALICON/fixations_imgs/train/'
# number of training images
nb_imgs_train = 10000
# path of validation images
imgs_val_path = imgs_train_path.replace('train', 'val')
# path of validation maps
maps_val_path = maps_train_path.replace('train', 'val')
# path of validation fixation maps
fixs_val_path = fixs_train_path.replace('train', 'val')
