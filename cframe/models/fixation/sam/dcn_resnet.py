...
def identity_block(input_tensor, kernel_size, filters, stage, block):
    ...
    x = Convolution2D(nb_filter1, kernel_size=1, name=conv_name_base + '2a')(input_tensor)
    ...
    x = Convolution2D(nb_filter3, kernel_size=1, name=conv_name_base + '2c')(x)
...
def conv_block(input_tensor, kernel_size, filters, stage, block, strides=(2, 2)):
    ...
    x = Convolution2D(nb_filter1, kernel_size=1, strides=strides,
    ...
    shortcut = Convolution2D(nb_filter3, kernel_size=1, strides=strides,
...
def conv_block_atrous(input_tensor, kernel_size, filters, stage, block, atrous_rate=(2, 2)):
    ...
    x = Convolution2D(nb_filter2, kernel_size=kernel_size, padding='same',
                      dilation_rate=atrous_rate, name=conv_name_base + '2b')(x)
    x = BatchNormalization(axis=bn_axis, name=bn_name_base + '2b')(x)
    x = Activation('relu')(x)
    ...
    shortcut = Convolution2D(nb_filter3, kernel_size=1, name=conv_name_base + '1')(input_tensor)
    shortcut = BatchNormalization(axis=bn_axis, name=bn_name_base + '1')(shortcut)
...
def identity_block_atrous(input_tensor, kernel_size, filters, stage, block, atrous_rate=(2, 2)):
    ...
    x = Convolution2D(nb_filter2, kernel_size=kernel_size, dilation_rate=atrous_rate,
                      padding='same', name=conv_name_base + '2b')(x)
    x = BatchNormalization(axis=bn_axis, name=bn_name_base + '2b')(x)
    x = Activation('relu')(x)
...
def dcn_resnet(input_tensor=None):
    ...
    x = Convolution2D(64, kernel_size=7, strides=2, name='conv1')(x)
